            ...
            <div className="flex space-x-2 overflow-x-auto pb-2">
              {product.images.map((image, index) => (
                <img
                  ...
                  className={`w-20 h-20 object-cover rounded-md cursor-pointer transition-opacity ${index === activeImage ? 'border-2 border-purple-500' : 'opacity-60 hover:opacity-100'}`}
